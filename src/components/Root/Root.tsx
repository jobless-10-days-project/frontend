    ...
    <UserContextProvider finishedInitialize={() => setUserInitialized(true)}>
      {userInitialized ? (
        ...
        <div role="status" className="absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%]">
          <svg aria-hidden="true" className="w-[8rem] h-[8rem] mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-[#E23A7A]" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
